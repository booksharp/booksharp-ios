...
@property (nonatomic,setter = setDatasource:) id<XLCycleScrollViewDatasource> datasource;
@property (nonatomic,setter = setDelegate:) id<XLCycleScrollViewDelegate> delegate;
